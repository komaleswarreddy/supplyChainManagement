...
import { useCustomerDetail, useUpdateCustomer } from '@/services/order';
...
export function EditCustomer() {
  ...
  useEffect(() => {
    if (customer) {
      reset({
        ...
        orderPreferences: {
          preferredShippingMethod: customer.orderPreferences?.preferredShippingMethod || '',
          preferredPaymentMethod: customer.orderPreferences?.preferredPaymentMethod || '',
          communicationPreferences: customer.orderPreferences?.communicationPreferences || ['email_order_updates'],
          specialInstructions: customer.orderPreferences?.specialInstructions || '',
        },
      });
    }
  }, [customer, reset]);
  ...
  const onSubmit = (data: UpdateCustomerForm) => {
    ...
    updateCustomerMutation.mutate(
      { customerId: customerId!, data: cleanData },
      {
        onSuccess: (updatedCustomer) => {
          setHasUnsavedChanges(false);
          toast({
            title: 'Customer Updated',
            description: `Customer ${updatedCustomer.firstName} ${updatedCustomer.lastName} has been successfully updated.`,
          });
          navigate(`/orders/customers/${updatedCustomer.id}`);
        },
        onError: (error) => {
          toast({
            title: 'Error',
  ...
  const nextStep = async () => {
    let fieldsToValidate: (keyof UpdateCustomerForm)[] = [];
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mb-4">
            The customer you're trying to edit doesn't exist or you don't have permission to edit it.
          </p>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button
            variant="outline"
            size="sm"
            onClick={() => navigate(`/orders/customers/${customerId}`)}
          >
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to Customer
          </Button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setValue('type', v === 'none' ? '' : v)}
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setValue('status', v === 'none' ? '' : v)}
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setValue('loyaltyTier', v === 'none' ? '' : v)}
                  >
                    <SelectTrigger>
                ...
                <div key={field.id} className="border rounded-lg p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <Select
                        value={watch(`addresses.${index}.type`) || 'none'}
                        onValueChange={v => setValue(`addresses.${index}.type`, v === 'none' ? '' : v)}
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Select
                        value={watch(`addresses.${index}.country`) || 'none'}
                        onValueChange={v => setValue(`addresses.${index}.country`, v === 'none' ? '' : v)}
                      >
                        <SelectTrigger>
                  ...
                  <div key={field.id} className="border rounded-lg p-4 space-y-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2">
                        ...
                        <Select
                          value={watch(`contacts.${index}.type`) || 'none'}
                          onValueChange={v => setValue(`contacts.${index}.type`, v === 'none' ? '' : v)}
                        >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setValue('orderPreferences.preferredShippingMethod', v === 'none' ? '' : v)}
                  >
                    <SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setValue('orderPreferences.preferredPaymentMethod', v === 'none' ? '' : v)}
                  >
                    <SelectTrigger>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            {currentStep < totalSteps ? (
              ...
              <Button
                type="submit"
                disabled={updateCustomerMutation.isPending || !hasUnsavedChanges}
              >
